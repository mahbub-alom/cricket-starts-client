...
const AllClasses = () => {
  ...
  return (
    <div className="pt-20">
      <Zoom>
        <h2 className="text-xl md:text-3xl font-bold text-center my-8 text-fuchsia-500 ">
          All Classes
        </h2>
      </Zoom>
      <div className="grid grid-cols-1 md:grid-cols-3 gap-5 w-11/12 mx-auto">
        {approvedClasses?.map((cls, index) => (
          <div
            key={index}
            className={`card w-full md:w-96  shadow-xl ${
          ...
          >
            <figure>
              <img className="w-full h-48 object-cover" src={cls?.classImage} />
            </figure>
            <div className="card-body">
              ...
              <p className="text-fuchsia-500 font-bold">Price: ${cls?.price}</p>
              <div className="card-actions justify-end">
                {isClassSelected(cls?._id) ? (
                  ...
                  <button
                    ...
                    disabled={
                      cls?.availableSeats == 0 || isAdmin || isInstructor
                    }
                    className={`btn text-black bg-fuchsia-500`}
                  >
                    Select
                  </button>
                )}
