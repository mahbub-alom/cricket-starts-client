      ...
      <div className=" flex flex-col justify-center ">
        <div className="max-w-[400px] w-full mx-auto rounded-lg bg-gray-200 p-8 shadow-2xl px-8">
          <form onSubmit={handleSubmit(onSubmit)}>
            <h2 className="text-4xl text-fuchsia-500 font-bold text-center">
              Log In
            </h2>
            ...
            <button className="w-full my-5 py-2 bg-fuchsia-700 shadow-lg shadow-fuchsia-500/50 hover:shadow-indigo-400/40 text-white font-semibold rounded-lg">
              Log In
            </button>
          </form>
          ...
          <button
            ...
            className="btn btn-black w-full btn-outline"
          >
