...
const ManageClasses = () => {
  ...
  const handleUpdateStatus = (cls, status) => {
    ...
    const url = `https://cricket-starts-server.vercel.app/classes/status/?id=${cls?._id}&status=${status}`;
    fetch(url, {
      method: "PATCH",
      headers: {
  ...
  const handleSubmitFeedback = (event) => {
    ...
    if (feedback !== "") {
      ...
      const url = `https://cricket-starts-server.vercel.app/classes/feedback/?id=${selectedClass._id}&feedback=${feedback}`;
      const token = localStorage.getItem("access-token");
      fetch(url, {
        method: "PATCH",
        headers: {
