...
const UpdateClass = () => {
  ...
  const cls = instructorClasses?.find(
    (cls) => parseFloat(cls._id) == parseFloat(id.id)
  );
  // console.log('sdf',cls);
        ...
        >
          ...
          <div>
            <input
              type="submit"
              value="Update Class"
              className="px-4 py-2 my-3 w-full font-semibold text-white bg-fuchsia-600 rounded-md hover:bg-fuchsia-800 focus:outline-none focus:bg-fuchsia-600"
            />
          </div>
        </form>
      </div>
