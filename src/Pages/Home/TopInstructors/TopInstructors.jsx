            ...
            >
                        ...
                        <div className={`card w-full md:w-[500px] h-72 lg:card-side ${cardBackgroundClass} shadow-2xl`}>
                            ...
                            <div className="card-body">
                                <div className="absolute top-0 right-4 ml-1 font-semibold">
                                    {index === 0 && <p className="badge bg-fuchsia-700 mx-3">Top</p>}
                                    <p className="badge bg-fuchsia-700 p-2">Popular</p>
                                </div>
                                    <div>
                                        <h2 className="font-bold md:text-xl text-md">{ins.name}</h2>
                                        <p className="md:text-lg text-sm font-semibold">Instructor</p>
                                    </div>
                                    <button className="btn btn-outline mt-auto bg-fuchsia-500 text-white text-xs md:text-md">View Details</button>
                                </div>
                        </div>
                    </SwiperSlide>
                ))}
                <SwiperSlide>
                    <div className="bg-indigo-200 rounded-2xl shadow-2xl w-44 md:w-[500px] h-72 flex flex-col justify-center items-center">
                        <Link to="/allClasses">
                            <button className="text-fuchsia-500 flex items-center justify-center gap-3 test-lg md:text-2xl font-bold mx-auto">
