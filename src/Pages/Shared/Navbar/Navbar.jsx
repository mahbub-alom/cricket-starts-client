...
const Navbar = () => {
  ...
  return (
    <div
      className={`navbar fixed z-10 max-w-screen-xl${
        isDark ? "bg-gray-900" : "bg-base-100"
      } shadow-sm shadow-primary h-10 `}
    >
      <div className="navbar-start">
        ...
        <Link to="/">
          <h1 className="text-md md:text-2xl text-fuchsia-500 font-bold md:ml-4">
            Cricket Stars Academy
          </h1>
        </Link>
      </div>
        ...
        {user ? (
          <>
            ...
            <button
              ...
              className="btn text-fuchsia-500 rounded-full btn-outline ml-5"
            >
