        ...
        <>
          <li>
            <NavLink
              ...
              className="text-white hover:bg-fuchsia-800 w-full rounded-lg px-4 py-2 mb-2 inline-block text-base leading-loose"
            >
              Selected Classes
            </NavLink>
          </li>
  ...
  return (
    <div className="w-72 bg-dark-purple h-full p-5  pt-8 relative">
      <div className="items-center">
        <h1 className={`text-fuchsia-500 origin-left font-medium text-xl `}>
          Hi, {user?.displayName}
        </h1>
